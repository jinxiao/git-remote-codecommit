...
EXPECTED_SIG = (
    "20171224T115320Zb6df2d758a8023b2f000a546417007b65494f3ce8ad0300fd45fcfa173f1959a"
)
...
def test_git_url_with_token(dt_mock):
    dt_mock.utcnow = Mock(return_value=TIMESTAMP)
    assert EXPECTED_URL_WITH_TOKEN == git_url(
        "test_repo", "v1", REGION, CREDENTIAL_WITH_TOKEN
    )
